...
class SymmetricMap():
    ...
    def print_map(self):
        ...
        print "agents_per_player", self.agents_per_player
        for (agent_row, agent_col), owner in self.agents:
            print 'a', agent_row, agent_col, 'n', owner
...
#            print self.row_t, self.col_t
    ...
    #returns all symmetrically equivalent squares
...
#                    print("visited ", n_loc[0], n_loc[1])
    ...
    def add_ants(self):
        ...
        self.fill_squares(self.a_loc, '.')
        locs = self.equivalent_squares(self.a_loc)
        count = 0
        for l in locs:
            self.agents.append((l, count))
            count +=1
...
#            print "validity checking completed"
#            print ('land squares =', self.land_squares, 'target = ', no_land_squares)
            self.walk_locations()
