...
from asteroids_tcpserver import load_map_info
...
#            """
    ...
    def serve_map( self, match ):      
        try:
            ...
            m = self.server.cache["/asteroids-maps/"+mapname]
        except:
    ...
    def serve_howto(self, match):
        ...
        <li>Run:<b> python tcpclient.py %s 2083 "python MyBot.py" username password [num_rounds] </b></li>
